# spin up eks cluster
eksctl create cluster --name eu-eks-cluster --region eu-north-1 --version 1.34 --instance-types t3.medium --nodes-min 3
...
k apply -f 0-gatewayclass-retail-banking.yaml
k apply -f 1-kong-api-gateway-retail-banking.yaml
k apply -f 2-customer-profile-httproute.yaml
k apply -f 3-customer-profile.yaml 
k apply -f 4-account.yaml 
k apply -f 5-statement.yaml
...
k apply -f 0-gatewayclass-payments.yaml 
k apply -f 1-kong-api-gateway-payments.yaml 
k apply -f 2-transfer-httproute.yaml 
k apply -f 3-transfer.yaml 
k apply -f 4-payment-gateway.yaml 
k apply -f 5-fx.yaml
